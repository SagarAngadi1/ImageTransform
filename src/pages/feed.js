...
//     const target = view === 'trending' ? trendingPosts : images;
//     const setTarget = view === 'trending' ? setTrendingPosts : setImages;
...
//               <img
//                 src={profileImages[image.user] || profileImages.default}
//                 alt="Profile"
//                 className="w-10 h-10 rounded-full border border-white/60 object-cover"
//               />
//               <div>
//                 <p className="font-semibold text-pink-600">@{image.user}</p>
//                 <p className="text-sm text-gray-500">{timeAgo(image.hoursAgo)}</p>
//               </div>
//             </div>

//             <p className="text-gray-700 mb-4">{image.content}</p>
//             {image.image && (
//               <img
...
//                 <button
//                   key={emoji}
//                   onClick={() => addReaction(image.id, emoji)}
//                   className="flex items-center gap-1 px-3 py-1 bg-white/80 text-lg rounded-full border border-gray-300 shadow-sm hover:scale-105 hover:bg-white transition-all duration-200"
//                 >
//                   {emoji} <span className="text-sm">{image.reactions[emoji] || 0}</span>
//                 </button>
//               ))}
//             </div>
//           </div>
...
//   return (
//     <div className="min-h-screen flex bg-gradient-to-br from-[#fff1eb] to-[#ace0f9]">
//       <div className="w-64">
//         <Sidebar currentUser={user} />
//       </div>
